...
enum FeedbackRuleSet {
    static let forehandDrive: [FeedbackRule] = [
        ...
        FeedbackRule(
            ...
            conditionType: .insideRange, threshold: nil, okMin: 1.0, okMax: 1.3,
            higherIsBetter: false, severity: .strength,
            observationTemplate: "Stance is {value_pct}% of shoulder width — within the 100–130% ideal range.",
        ...
        FeedbackRule(
            ...
            minFrames: 3,
            windowStart: 0.0, windowEnd: 0.25,
            conditionType: .below, threshold: 1.0, okMin: 1.0, okMax: 1.3,
        ...
        FeedbackRule(
            ...
            minFrames: 3,
            windowStart: 0.0, windowEnd: 0.25,
            conditionType: .above, threshold: 1.3, okMin: 1.0, okMax: 1.3,
            higherIsBetter: false, severity: .improvement,
        ...
        FeedbackRule(
            ...
            conditionType: .insideRange, threshold: nil, okMin: 140.0, okMax: 170.0,
            higherIsBetter: false, severity: .strength,
            observationTemplate: "Knee angle is {value_int}° — within the 140–170° ideal loading range.",
        ...
        FeedbackRule(
            ...
            minFrames: 3,
            windowStart: 0.1, windowEnd: 0.3,
            conditionType: .above, threshold: 170.0, okMin: 140.0, okMax: 170.0,
            higherIsBetter: false, severity: .improvement,
        ...
        FeedbackRule(
            ...
            minFrames: 3,
            windowStart: 0.1, windowEnd: 0.3,
            conditionType: .below, threshold: 140.0, okMin: 140.0, okMax: 170.0,
            higherIsBetter: false, severity: .improvement,
        ...
        FeedbackRule(
            ...
            conditionType: .insideRange, threshold: nil, okMin: 20.0, okMax: 50.0,
            higherIsBetter: true, severity: .strength,
            observationTemplate: "Peak hip–shoulder separation is {value_int}° — within the 20–50° ideal range for kinetic chain transfer.",
        ...
        FeedbackRule(
            ...
            minFrames: 3,
            windowStart: 0.3, windowEnd: 0.7,
            conditionType: .below, threshold: 20.0, okMin: 20.0, okMax: 50.0,
        ...
        FeedbackRule(
            ...
            conditionType: .above, threshold: 0.0, okMin: 0.0, okMax: 1.5,
            higherIsBetter: true, severity: .strength,
            observationTemplate: "Paddle finished above shoulder height — follow-through is complete.",
        ...
        FeedbackRule(
            ...
            minFrames: 3,
            windowStart: 0.7, windowEnd: 1.0,
            conditionType: .below, threshold: 0.0, okMin: 0.0, okMax: 1.5,
            higherIsBetter: true, severity: .improvement,
